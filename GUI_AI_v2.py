...
# Form implementation generated from reading ui file 'D:\Python\ezgeo\Simple_PySide_Base-master\GUI_AI_v2.ui'
#
...
"}")
        ...
        self.page_collection = QtWidgets.QWidget()
        self.page_collection.setObjectName("page_collection")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.page_collection)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.frame_4 = QtWidgets.QFrame(self.page_collection)
...
"border-radius: 5px;")
        ...
        self.label_cam3 = QtWidgets.QLabel(self.frame_4)
        self.label_cam3.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.label_cam3.setFont(font)
        self.label_cam3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_cam3.setObjectName("label_cam3")
        self.gridLayout_3.addWidget(self.label_cam3, 0, 2, 1, 1)
        self.label_cam2 = QtWidgets.QLabel(self.frame_4)
        self.label_cam2.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_cam1 = QtWidgets.QLabel(self.frame_4)
        self.label_cam1.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_cam1 = QtWidgets.QPushButton(self.frame_4)
        self.btn_cam1.setMaximumSize(QtCore.QSize(16777215, 50))
        self.btn_cam1.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("D:\\Python\\ezgeo\\Simple_PySide_Base-master\\Off.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap("D:\\Python\\ezgeo\\Simple_PySide_Base-master\\On.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.btn_cam1.setIcon(icon3)
        self.btn_cam1.setIconSize(QtCore.QSize(135, 45))
        self.btn_cam1.setObjectName("btn_cam1")
        self.gridLayout_3.addWidget(self.btn_cam1, 1, 0, 1, 1)
        self.btn_cam2 = QtWidgets.QPushButton(self.frame_4)
        self.btn_cam2.setMaximumSize(QtCore.QSize(16777215, 50))
        self.btn_cam2.setText("")
        self.btn_cam2.setIcon(icon3)
        self.btn_cam2.setIconSize(QtCore.QSize(135, 45))
        self.btn_cam2.setObjectName("btn_cam2")
        self.gridLayout_3.addWidget(self.btn_cam2, 1, 1, 1, 1)
        self.btn_cam3 = QtWidgets.QPushButton(self.frame_4)
        self.btn_cam3.setMaximumSize(QtCore.QSize(16777215, 50))
        self.btn_cam3.setText("")
        self.btn_cam3.setIcon(icon3)
        self.btn_cam3.setIconSize(QtCore.QSize(135, 45))
        ...
        self.frame_5 = QtWidgets.QFrame(self.page_collection)
        self.frame_5.setMaximumSize(QtCore.QSize(16777213, 50))
...
"border-radius: 5px;")
        ...
        self.btn_test = QtWidgets.QPushButton(self.frame_5)
        self.btn_test.setMinimumSize(QtCore.QSize(120, 30))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("D:\\Python\\ezgeo\\Simple_PySide_Base-master\\icons/20x20/cil-pencil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_test.setIcon(icon4)
        self.btn_test.setObjectName("btn_test")
        self.horizontalLayout_14.addWidget(self.btn_test)
        self.btn_scan = QtWidgets.QPushButton(self.frame_5)
        self.btn_scan.setMinimumSize(QtCore.QSize(120, 30))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("D:\\Python\\ezgeo\\Simple_PySide_Base-master\\icons/20x20/cil-camera.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.frame_6 = QtWidgets.QFrame(self.page_collection)
...
"border-radius: 5px;")
        ...
        self.label_scan_image = QtWidgets.QLabel(self.frame_6)
        self.label_scan_image.setText("")
        self.label_scan_image.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.verticalFrame = QtWidgets.QFrame(self.page_analysis)
        self.verticalFrame.setGeometry(QtCore.QRect(0, 0, 900, 600))
        self.verticalFrame.setObjectName("verticalFrame")
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.verticalFrame)
        self.verticalLayout_14.setContentsMargins(7, 7, 7, 7)
...
"border-radius: 5px;")
        ...
        self.horizontalLayout_15 = QtWidgets.QHBoxLayout(self.horizontalFrame_2)
...
"}")
        ...
        self.gridFrame_3 = QtWidgets.QFrame(self.verticalFrame)
...
"border-radius: 5px;")
        ...
        self.scrollArea_2 = QtWidgets.QScrollArea(self.gridFrame_3)
...
" }")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 854, 514))
        self.scrollAreaWidgetContents_4.setObjectName("scrollAreaWidgetContents_4")
        self.label = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        self.label.setGeometry(QtCore.QRect(180, 190, 56, 12))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        self.label_2.setGeometry(QtCore.QRect(450, 230, 56, 12))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        self.label_3.setGeometry(QtCore.QRect(360, 370, 56, 12))
        ...
        self.verticalFrame1 = QtWidgets.QFrame(self.page_management)
        self.verticalFrame1.setGeometry(QtCore.QRect(0, 0, 900, 600))
        self.verticalFrame1.setObjectName("verticalFrame1")
        self.verticalLayout_16 = QtWidgets.QVBoxLayout(self.verticalFrame1)
        self.verticalLayout_16.setContentsMargins(7, 7, 7, 7)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.horizontalFrame_21 = QtWidgets.QFrame(self.verticalFrame1)
        self.horizontalFrame_21.setMaximumSize(QtCore.QSize(16777215, 50))
...
"border-radius: 5px;")
        ...
        self.horizontalLayout_17 = QtWidgets.QHBoxLayout(self.horizontalFrame_21)
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.comboBox_3 = QtWidgets.QComboBox(self.horizontalFrame_21)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(8)
...
"}")
        ...
        self.horizontalFrame_22 = QtWidgets.QFrame(self.verticalFrame1)
        self.horizontalFrame_22.setMinimumSize(QtCore.QSize(0, 300))
        self.horizontalFrame_22.setStyleSheet("")
        self.horizontalFrame_22.setObjectName("horizontalFrame_22")
        self.horizontalLayout_19 = QtWidgets.QHBoxLayout(self.horizontalFrame_22)
        self.horizontalLayout_19.setContentsMargins(0, -1, 0, -1)
        self.horizontalLayout_19.setObjectName("horizontalLayout_19")
        self.verticalFrame2 = QtWidgets.QFrame(self.horizontalFrame_22)
        self.verticalFrame2.setStyleSheet("background-color: rgb(39, 44, 54);\n"
"border-radius: 5px;")
        self.verticalFrame2.setObjectName("verticalFrame2")
        self.verticalLayout_18 = QtWidgets.QVBoxLayout(self.verticalFrame2)
        self.verticalLayout_18.setObjectName("verticalLayout_18")
        self.textile_text = QtWidgets.QLabel(self.verticalFrame2)
        self.textile_text.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.textile_image = QtWidgets.QLabel(self.verticalFrame2)
        ...
        self.verticalFrame_2 = QtWidgets.QFrame(self.horizontalFrame_22)
        self.verticalFrame_2.setStyleSheet("background-color: rgb(39, 44, 54);\n"
"border-radius: 5px;")
        self.verticalFrame_2.setObjectName("verticalFrame_2")
        self.verticalLayout_19 = QtWidgets.QVBoxLayout(self.verticalFrame_2)
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.mask_text = QtWidgets.QLabel(self.verticalFrame_2)
        self.mask_text.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.mask_image = QtWidgets.QLabel(self.verticalFrame_2)
        ...
        self.verticalFrame3 = QtWidgets.QFrame(self.verticalFrame1)
        self.verticalFrame3.setStyleSheet("background-color: rgb(39, 44, 54);\n"
"border-radius: 5px;")
        self.verticalFrame3.setObjectName("verticalFrame3")
        self.verticalLayout_17 = QtWidgets.QVBoxLayout(self.verticalFrame3)
        self.verticalLayout_17.setObjectName("verticalLayout_17")
        self.tableWidget_2 = QtWidgets.QTableWidget(self.verticalFrame3)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_cam3.setText(_translate("MainWindow", "3번 라인카메라"))
        self.label_cam2.setText(_translate("MainWindow", "2번 라인카메라"))
        self.label_cam1.setText(_translate("MainWindow", "1번 라인카메라"))
        self.btn_test.setText(_translate("MainWindow", "테스트"))
        self.btn_scan.setText(_translate("MainWindow", "연속 스캔"))
        self.comboBox_2.setItemText(0, _translate("MainWindow", "3열"))
        self.comboBox_2.setItemText(1, _translate("MainWindow", "4열"))
        self.comboBox_2.setItemText(2, _translate("MainWindow", "5열"))
        self.label.setText(_translate("MainWindow", "TextLabel"))
        self.label_2.setText(_translate("MainWindow", "TextLabel"))
        self.label_3.setText(_translate("MainWindow", "TextLabel"))
        self.comboBox_3.setItemText(0, _translate("MainWindow", "Test1"))
        self.textile_text.setText(_translate("MainWindow", "< 원단 이미지 >"))
        self.mask_text.setText(_translate("MainWindow", "< Mask 이미지 >"))
        ...
        item.setText(_translate("MainWindow", "패턴 종류"))
        item = self.tableWidget_2.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "사이즈"))
        item = self.tableWidget_2.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "이미지 추출 갯수"))
        item = self.tableWidget_2.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "생성 버튼"))
