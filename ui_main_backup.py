...
"}")
        ...
        self.page_collection.setObjectName(u"page_collection")
        self.verticalLayout_10 = QVBoxLayout(self.page_collection)
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")

        self.gridLayout_3 = QGridLayout()
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.label_cam1 = QLabel(self.page_collection)
        ...
        self.label_cam2 = QLabel(self.page_collection)
        ...
        self.label_cam3 = QLabel(self.page_collection)
        self.label_cam3.setAlignment(Qt.AlignCenter)
        self.label_cam3.setObjectName(u"label_cam3")
        self.gridLayout_3.addWidget(self.label_cam3, 0, 2, 1, 1)
        self.btn_cam1 = QPushButton(self.page_collection)
        self.btn_cam1.setText(u"")
        icon1 = QIcon()
        icon1.addPixmap(QPixmap(u"Off.png"), QIcon.Normal, QIcon.Off)
        icon1.addPixmap(QPixmap(u"On.png"), QIcon.Normal, QIcon.On)
        self.btn_cam1.setIcon(icon1)
        self.btn_cam1.setIconSize(QSize(135, 45))
        self.btn_cam1.setObjectName(u"btn_cam1")
        self.gridLayout_3.addWidget(self.btn_cam1, 1, 0, 1, 1)
        self.btn_cam2 = QPushButton(self.page_collection)
        self.btn_cam2.setText(u"")
        icon2 = QIcon()
        icon2.addPixmap(QPixmap(u"Off.png"), QIcon.Normal, QIcon.Off)
        icon2.addPixmap(QPixmap(u"On.png"), QIcon.Normal, QIcon.On)
        self.btn_cam2.setIcon(icon2)
        self.btn_cam2.setIconSize(QSize(135, 45))
        self.btn_cam2.setObjectName(u"btn_cam2")
        self.gridLayout_3.addWidget(self.btn_cam2, 1, 1, 1, 1)
        self.btn_cam3 = QPushButton(self.page_collection)
        self.btn_cam3.setText(u"")
        icon3 = QIcon()
        ...
        self.btn_cam3.setObjectName(u"btn_cam3")
        self.gridLayout_3.addWidget(self.btn_cam3, 1, 2, 1, 1)
        self.verticalLayout_10.addLayout(self.gridLayout_3)
        self.horizontalLayout_13 = QHBoxLayout()
        self.horizontalLayout_13.setObjectName(u"horizontalLayout_13")
        # self.horizontalLayout_13.setStyleSheet(u"background-color: rgb(39, 44, 54);")
        self.btn_test = QPushButton(self.page_collection)
        self.btn_test.setObjectName(u"btn_test")
        # self.btn_test.setStyleSheet("background-color: black;" "font-weight: bold;")
        self.btn_test.setMinimumSize(QSize(150, 30))
        font8 = QFont()
        font8.setFamily(u"Segoe UI")
        font8.setPointSize(9)
        self.btn_test.setFont(font8)
        self.btn_test.setStyleSheet(u"QPushButton {\n"
                                      ...
                                      "}")
        self.horizontalLayout_13.addWidget(self.btn_test)
        self.btn_scan = QPushButton(self.page_collection)
        self.btn_scan.setObjectName(u"btn_scan")
        # self.btn_scan.setStyleSheet("background-color: black;" "font-weight: bold;")
        self.btn_scan.setMinimumSize(QSize(150, 30))
        font8 = QFont()
        font8.setFamily(u"Segoe UI")
        font8.setPointSize(9)
        self.btn_scan.setFont(font8)
        self.btn_scan.setStyleSheet(u"QPushButton {\n"
                                    ...
                                    "	border: 2px solid rgb(43, 50, 61);\n"
                                    "}")
        self.horizontalLayout_13.addWidget(self.btn_scan)
        spacerItem = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        self.horizontalLayout_13.addItem(spacerItem)
        self.verticalLayout_10.addLayout(self.horizontalLayout_13)
        self.gridLayout_4 = QGridLayout()
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.label_scan_image = QLabel(self.page_collection)
        self.label_scan_image.setText(u"")
        self.label_scan_image.setObjectName(u"label_scan_image")
